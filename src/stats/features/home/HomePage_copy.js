        ...
        <ScrollView
          ...
          <View style={styles.homepage}>
                ...
                <View style={[styles.overview, styles.mt16, {width: 400}]}>
                  <View style={styles.name}>
                    ...
                    <View style={[styles.total, styles.mt4]}>
                      ...
                      <Text style={[styles.text1, styles.ml4]}>đ</Text>
                    </View>
                  </View>
                  ...
                  <View style={[styles.name, styles.ml16]}>
                    ...
                    <View style={[styles.total, styles.mt4]}>
                      ...
                      <Text style={[styles.text1, styles.ml4]}>sp</Text>
                      {/* <Image
                        style={[styles.totalChild, styles.ml4]}
                        resizeMode="cover"
            ...
            <View style={[styles.body]}>
              ...
              <View style={[styles.orderShadowBox, styles.mt16, {height: 450}]}>
                <View
              ...
              <View style={[styles.orderShadowBox, styles.mt16]}>
                <View style={styles.acount}>
                  <View style={styles.title1}>
                    <Image
                      style={styles.orderIcon}
                ...
                <View style={[styles.content1, styles.mt16]}>
                  ...
                  <View style={[]}>
                    <Image
                      style={styles.verticalLinesIcon1}
                      resizeMode="cover"
